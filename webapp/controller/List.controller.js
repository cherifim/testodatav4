sap.ui.define([
    ...
    return BaseController.extend("fr.stms.testodatav4.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "fr.stms.testodatav4.view.ViewSettingsDialog",
                    controller: this
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                teamId : oItem.getBindingContext().getProperty("TeamId")
            }, bReplace);
        },
