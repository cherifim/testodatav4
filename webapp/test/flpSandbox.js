		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test OData V4",
									"targetURL": "#frstmstestodatav4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"frstmstestodatav4-display": {
								"semanticObject": "frstmstestodatav4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fr.stms.testodatav4",
									"url": sap.ui.require.toUrl("fr/stms/testodatav4")
								}
							}
						}
					}
